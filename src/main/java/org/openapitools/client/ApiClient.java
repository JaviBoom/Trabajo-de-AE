...
public class ApiClient extends JavaTimeFormatter {
  ...
  private String basePath = "https://sandbox.viafirma.com/signservices";
  protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "https://sandbox.viafirma.com/signservices",
  ...
  public ApiClient(CloseableHttpClient httpClient) {
    ...
    setUserAgent("OpenAPI-Generator/1.3.29-r83-596fbc1/java");
